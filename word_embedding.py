...
class W2V(WordEmbedding):
    ...
    def prepare_data(self,
        ...
        x : pd.Series, optional
            Data on which to train the Word2Vec model, by default None
        y : pd.Series, optional
            Target data, by default None
        nn_classifier : bool, optional
            Type of classifier for which data needs to be prepared, by default
            True
        """
    ...
    def vectorization(self,
        ...
        ----------
        data : pd.Series
            Data in input to vectorize
        save_dataframe:bool, optional
            Whether to save the output locally, by default True
        dst_df_path : str, optional
            Path where to save the .csv file generated by the function
        dst_df_name : str, optional
            Name of the .csv, by default "embedding_data"

        Returns
        -------
        np.Series
            A pd.Series containing the vectorization made by Word2Vec of each
            document present in the input
        """
        vectors = []
        for row in data:
